...
SECRET_KEY = 'django-insecure-t4+qksd&2h7g@gu2b6c(&#mai!irpdk%iw9-n=v-1cel-sxy-%'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [("127.0.0.1", 6379)],  # Redis config (Docker-hostname:port)
        },
    },
}
# Database
...
WEBRTC_CONFIG = {
    'ICE_SERVERS': [
        ...
        {
            'urls': 'turns:video.conqod.site:5349',
            'username': 'test',
            'credential': 'test123'
        }
    ],
